...
- Responsive gallery items with fixed size using `object-fit`.
- Simple, colorful UI built with HTML, CSS, and PHP.
...
*(screenshot of imgdump before login was implemented)*
...
```bash
git clone https://github.com/awshly/Imgdump.git
cd imgdump
